  ...
  */
  ...
  if (currentMillis - previousMillis >= ms) {
    ...
    if (aktywacja >= warAktywacji && automatyczny ) {
      ...
      digitalWrite(D0, HIGH);
      digitalWrite(D1, HIGH);
      //logMessage[logNr++]="<tr><td>"+currentDate+"</td><td> Auto STOP \n"+"</td></tr>";
      if(WiFi.localIP()[3]==64){
        digitalWrite(D2, HIGH);
        digitalWrite(D3, HIGH);
        //logMessage[logNr++]="<tr><td>"+currentDate+"</td><td> Auto STOP 2"+"</td></tr>"; 
      }
      ...
      if ((currentHour * 60 + currentMinute) >= (Sunrise + SunriseHourOffset * 60 + SunriseMinuteOffset) && (currentHour * 60 + currentMinute) < (Sunset + SunsetHourOffset * 60 + SunsetMinuteOffset) && x_times_up < 10) {
        Serial.print("UP \n");
        logMessage[logNr++]="<tr><td>"+currentDate+"</td><td> Auto UP"+"</td></tr>";
        delay(2000);
        digitalWrite(D0, LOW);
        if(na_raz==HIGH){
        ...
        delay(2000);
        if(WiFi.localIP()[3]==64){
          logMessage[logNr++]="<tr><td>"+currentDate+"</td><td> Auto UP 2 "+"</td></tr>";
          digitalWrite(D2, LOW);
          if(na_raz==HIGH){
        ...
        Serial.print("DOWN \n");
        logMessage[logNr++]+="<tr><td>"+currentDate+"</td><td>Auto DOWN "+"</td></tr>";
        delay(2000);
        digitalWrite(D1, LOW);
        if(na_raz==HIGH){
        ...
        delay(2000);
        if(WiFi.localIP()[3]==64){
          logMessage[logNr++]="<tr><td>"+currentDate+"</td><td> Auto DOWN 2 "+"</td></tr>";
          digitalWrite(D3, LOW);
          if(na_raz==HIGH){
